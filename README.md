...
Copy the [Stable Diffusion weights](https://huggingface.co/CompVis/stable-diffusion-v-1-4-original) into `stable-diffusion/models/ldm/stable-diffusion-v1/model.ckpt`.
